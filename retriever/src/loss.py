...
class Loss(Module):
    ...
    def contrastive_loss(self, labels, logits, masks, temperature=0.25):
    ...
    def caculate_cosin_loss(self, labels, query_embeddings, context_embeddings, masks, temperature=0.25):
    ...
    def caculate_dot_product_loss(self, labels, query_embeddings, context_embeddings, masks, temperature=8):
